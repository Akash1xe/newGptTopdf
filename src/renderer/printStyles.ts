...
.export-document { width: min(920px, calc(100% - 32px)); margin: 24px auto 64px; padding: 40px 46px; background: #fff; color: #18181b; box-shadow: 0 10px 40px rgba(0,0,0,.08); font-family: var(--pdf-body-font); font-size: var(--pdf-body-size); font-weight: var(--pdf-body-weight); line-height: var(--pdf-line-height); }
...
.document-title { font-size: 1.85em; line-height: 1.2; letter-spacing: -.025em; margin: 0 0 .2em; font-weight: var(--pdf-title-weight); }
.document-subtitle { color: #71717a; font-size: .78em; font-weight: var(--pdf-meta-weight); text-transform: uppercase; letter-spacing: .08em; }
.theme-dark .document-subtitle, .theme-dark .document-meta { color: #a1a1aa; }
.document-meta { margin-top: .7em; display: flex; flex-wrap: wrap; gap: .6em 1.2em; color: #71717a; font-size: .72em; font-weight: var(--pdf-meta-weight); }
.message { margin: 0 0 var(--pdf-message-gap); break-inside: auto; }
.message-role { display: inline-block; margin-bottom: .5em; font-size: .7em; font-weight: var(--pdf-role-weight); text-transform: uppercase; letter-spacing: .11em; color: #52525b; }
...
h1,h2,h3,h4,h5,h6 { line-height: 1.28; margin: 1.25em 0 .55em; break-after: avoid; page-break-after: avoid; font-weight: var(--pdf-heading-weight); }
...
.code-label { padding: 6px 10px; border-bottom: 1px solid #e4e4e7; font-family: -apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif; font-size: 10px; font-weight: var(--pdf-code-label-weight); line-height: 1.3; color: #52525b; background: #f4f4f5; }
...
th { background: #f4f4f5; font-weight: var(--pdf-table-header-weight); }
...
.media-block figcaption { margin-top: .45em; font-size: .8em; font-weight: var(--pdf-meta-weight); color: #71717a; }
.media-placeholder { padding: 1em; border: 1px dashed #a1a1aa; color: #71717a; font-size: .85em; font-weight: var(--pdf-meta-weight); }
@media print {
